			...
			<ul>
				...
				<li class="has_sub">
					<a href="#" class="waves-effect <?=(
						...
						$this->router->fetch_class() == 'departamentos' or
						$this->router->fetch_class() == 'auth' &&
						$this->router->fetch_method() == 'index'
						) ? 'active' : null; ?>"><i class="md md-view-list"></i><span> Gerenciamento </span><span class="pull-right"><i class="md md-add"></i></span></a>
					<ul class="list-unstyled">
						...
						<?if ($this->ion_auth->is_admin()):?>
							<li <?=($this->router->fetch_class() == 'auth') ? 'class="active"' : null; ?>><a href="<?=base_url('auth/index')?>">Usuários do Sistema</a></li>
				...
				<li>
					<a href="<?=base_url('empresas')?>" class="waves-effect <?=($this->router->fetch_class() == 'empresas') ? 'active' : null; ?>"><i class="md md-view-list"></i><span> Empresas </span></a>
				</li>

				<li>
					<a href="<?=base_url('contatos')?>" class="waves-effect <?=($this->router->fetch_class() == 'contatos') ? 'active' : null; ?>"><i class="md md-view-list"></i><span> Contatos </span></a>
				</li>

				<li class="has_sub">
					<a href="javascript:void(0);" class="waves-effect"><i class="md md-share"></i><span>Extração </span><span class="pull-right"><i class="md md-add"></i></span></a>
					<ul>
						<li>
