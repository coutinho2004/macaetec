<h3 class="page-header">Gerenciar Departamento</h3>
<div class="row">
	...
	<header class="panel-heading">
		<div class="row">
			...
			<div class="col-md-8 col-xs-9">
				<?php echo form_open(base_url('departamentos/search'), 'role="search" class="form"') ;?>
					<div class="input-group pull-right">
						<input type="text" class="form-control input-sm" placeholder="Pesquisar" name="q" id="q" autocomplete="off">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<?php
							echo anchor(
								base_url("departamentos/edit/{$o->id}"),
						...
						<?php
							if($this->ion_auth->in_group(1)){
								echo anchor(
									base_url("departamentos/destroy/{$o->id}"),
...
<script>
	$(function(){
		...
		$("#q").autocomplete({
			source: "departamentos/autocomplete",
			minLength: 3,
