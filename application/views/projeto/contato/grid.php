<h1 class="page-header">Funil de Vendas</h1>
<h4><i><strong><?=$contato?></strong></i></h4>
<div class="row">
	...
	<header class="panel-heading">
		<div class="row">
			<div class="col-md-8 col-xs-3">
				<?php
					echo anchor(
						base_url("funil/addContato/$idEmpresa/$idContato"),
			...
			<div class="col-md-4 col-xs-9">
				<?php echo form_open(base_url('macaetec/funilVendaSearch'), 'role="search" class="form"') ;?>
					<div class="input-group pull-right">
						<input type="text" class="form-control input-sm" placeholder="Pesquisar" name="q" autocomplete="off">
		...
		<table class="table table-hover table-condensed">
			...
			<tbody>
				...
				<tr>
					...
					<td><?php echo word_limiter($o->descricao,3);?></td>
					<td><?php echo $o->valor;?></td>
					<td>
						<?php
							echo anchor(
								base_url("funil/editContato/$idEmpresa/$idContato/{$o->id}"),
