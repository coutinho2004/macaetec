...
<div class="panel panel-default">
	<div class="panel-heading"><i class="glyphicon glyphicon-edit"></i></div>
		<div class="panel-body">
			...
			<?php echo form_hidden('idEmpresa',$idEmpresa);?>
			<?php echo form_hidden('idContato',$idContato);?>
			<?php echo form_hidden('idFunil',$idFunil);?>
		</div> <!--/ Panel Body -->
		<div class="panel-footer">
			<div class="row">
				<div class="col-md-10 col-sm-12 col-md-offset-2 col-sm-offset-0">
					<a href="<?php echo base_url("macaetec/empresaContatoFunilVendaEdit/$idEmpresa/$idContato/$idFunil"); ?>" class="btn btn-default">
