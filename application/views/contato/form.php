...
<div class="panel panel-default">
	<div class="panel-heading">
		...
		<i><strong>Empresa</strong> - <?php	echo $obj->empresa->get()->nome;?></i>
	</div>
	<div class="panel-body">
		...
		<div class="form-group">
			<label for="email" class="col-sm-2 control-label">E-mail fdsaf<span class="required-input">*</span></label>
			<div class="col-sm-6">
				<?php
				echo form_input(
				array(
...
<?php if($obj->exists()):?>
			...
			<ul class="nav nav-tabs">
				<li class="active"><a href="#historico" data-toggle="tab">Histórico(s)</a></li>
			</ul>

			<!-- Tab panes -->
			<div class="tab-content">
				<div class="tab-pane fade in active" id="historico">
					<?php $this->load->view('empresa/contato/historico/view');?>
				</div>
			</div>
<?php endif?>