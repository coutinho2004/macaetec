...
<section class="panel panel-default">
	<header class="panel-heading">
		<div class="row">
			<div class="col-md-8 col-xs-3">
				<?php
					echo anchor(
						base_url("macaetec/empresaHistoricoAdd/{$obj->id}/"),
	...
	<div class="panel-body">
		<?php if ($obj->historico->get()->exists()) : ?>
		<table class="table table-hover table-condensed">
			...
			<tbody>
				<?php foreach ($obj->historico->get() as $o) : ?>
				<tr>
					...
					<td>
						<?php
							echo anchor(
								base_url("macaetec/empresaHistoricoEdit/{$obj->id}/{$o->id}"),
						...
						<?php
							if($this->ion_auth->in_group(1)){
								echo anchor(
									base_url("macaetec/empresaHistoricoDestroy/{$obj->id}/{$o->id}"),
