...
<section class="panel panel-default">
	<header class="panel-heading">
		<div class="row">
			<div class="col-md-8 col-xs-3">
				<?php
					echo anchor(
						base_url("contatos_historicos/add/$idUser/{$obj->id}/"),
	...
	<div class="panel-body">
		<?php if ($obj->contato_historico->get()->exists()) : ?>
		<table class="table table-hover table-condensed">
			...
			<tbody>
				<?php foreach ($obj->contato_historico->get() as $o) : ?>
				<tr>
					...
					<td>
						<?php
							echo anchor(
								base_url("contatos_historicos/edit/$idUser/{$obj->id}/{$o->id}"),
						...
						<?php
							if($this->ion_auth->in_group(1)){
								echo anchor(
									base_url("contatos_historicos/destroy/$idUser/{$obj->id}/{$o->id}"),
